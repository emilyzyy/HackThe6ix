...
class DemoApp:
    ...
    def on_stream_stopped(self):
        ...
        self.event.set()  # Unblock the main thread so it can exit.
    ...
    def get_pose_mat_from_camera_pose(self, pose):
        """Build a 4x4 camera-to-world transform from the quaternion + translation."""
    ...
    def start_processing_stream(self):
        while True:
            ...
            if self.frame_count % 30 == 0:
                print(intrinsic_mat)
                print('Camera pose: quat(x,y,z,w) = ({:.4f}, {:.4f}, {:.4f}, {:.4f}), pos(x,y,z) = ({:.4f}, {:.4f}, {:.4f})'
                      .format(camera_pose.qx, camera_pose.qy, camera_pose.qz, camera_pose.qw,
                              camera_pose.tx, camera_pose.ty, camera_pose.tz))
                print(self.get_pose_mat_from_camera_pose(camera_pose))
            self.frame_count += 1
